...
illustrative: true
---
# Design Document: Synthetic analytics

## Overview
Implement ANALYTICS-ORG-001 through one explicit boundary adapter.
...
For every accepted item, all fields required by the pinned definition survive the adapter; invalid input is rejected (ANALYTICS-ORG-001).
