...
illustrative: true
---
# Requirements: Synthetic checkout
...
## Requirements
**CHECKOUT-ORG-001 — Shared catalog boundary**
When a catalog item is supplied, the checkout component shall preserve item_id and price and required currency under the pinned shared contract.
